...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="align-items-center siteHeader">

      <p class="tagline">A four-star hotel in a suburb of New Delhi, India</p>
      <p class="logo me-auto"><a href="/">Dia Park Premier</a></p>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li class="nav-item" id="room">
              <a class="nav-link" href="/english/room/index.html">Guest Rooms</a>
          </li>
          <li class="nav-item" id="meal">
            <a class="nav-link" href="/english/dining/index.html">Food Services</a>
          </li>
          <li class="nav-item" id="service">
            <a href="/english/service/index.html">Services &amp; Facilities</a>
          </li>
          <li class="nav-item" id="news">
            <a class="nav-linkd" href="/english/news/index.html">News</a>
          </li>
          <li class="nav-item" id="access">
              <a class="nav-link" href="/english/access/index.html">Access</a>
            </li>
  
            <li class="nav-item" id="booking">
              <a class="nav-link" href="https://gc.synxis.com/rez.aspx?Hotel=80472&amp;Chain=22924&amp;locale=en-US">Room Reservations</a>
            </li>
  
            <li class="nav-item" id="contact">
              <a class="nav-link" href="/english/contact/index.html">Inquiries</a>
            </li>
        </ul>
        <i class="bi bi-list mobile-nav-toggle"></i>
      </nav>
      ...
      <a href="#bookTable" class="btn btn-warning get-started-btn btn-lg blink">Book A Table</a>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="/landing/img/ban-1.jpg" class="d-block w-100" alt="raifu banner 1">
        </div>
        <div class="carousel-item">
          <img src="/landing/img/ban-2.jpg" class="d-block w-100" alt="raifu banner 2">
        </div>
        <div class="carousel-item">
      ...
      <!-- <center> 
        <a href="#bookTable" class="btn btn-warning btn-get-started btn-lg blink">Book a Table</a>
        </button>
        </center> -->
    </div>
</section>
                        ...
                        <select class="form-select" name="restaurantid" id="restaurantid" required="true" style="text-align: center; font-size: 2.0em; height: 56px;">
                            ...
                            @if(!empty($restaurants))
                                @foreach($restaurants as $restaurant)
                                    <option value="{{$restaurant->id}}" {{$restaurant->id == 1 ? 'selected' : ''}}>{{$restaurant->name}}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
...
<div class="col-12">
                ...
                <input type="hidden" name="url" class="form-control" id="admin" value="{{'https://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']}}"> 
